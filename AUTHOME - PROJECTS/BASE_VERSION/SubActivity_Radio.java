...
public class SubActivity_Radio extends AppCompatActivity
{
    TextView textView, lightOneText, lightTwoText, lightThreeText, fanDisp, timerText,roomName;
    int timeBeforeFlush = 350;
    int timeAfterFlush = 350;
    ...
    DhcpInfo dhcpInfo;
    RadioButton switchButton1, switchButton2, switchButton3, fanButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sub_radio);
        ...
        switchButton1    = (RadioButton)findViewById(R.id.lightOne);
        switchButton2    = (RadioButton)findViewById(R.id.lightTwo);
        switchButton3    = (RadioButton)findViewById(R.id.lightThree);
        fanButton        = (RadioButton)findViewById(R.id.fan);
    ...
    public void callSubActivityAgain()
    {
        Intent i = new Intent(SubActivity_Radio.this, SubActivity_Radio.class);
        finish();
    ...
    {
        Intent intent = new Intent(SubActivity_Radio.this, MainActivity.class);
...
/*
boolean checked = ((RadioButton) view).isActivated();
        switch(view.getId())
        {
            case R.id.lightOne:
                if (checked)
