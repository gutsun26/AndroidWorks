...
public class SubActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            if(roomConfig.charAt(i) == '1' || roomConfig.charAt(i) == '0' || roomConfig.charAt(i) == '2' || roomConfig.charAt(i) == '3' || roomConfig.charAt(i) == '4' || roomConfig.charAt(i) == '5' || roomConfig.charAt(i) == '6')
            {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            case R.id.item1:
                Toast.makeText(this, "AUTO_HOME WIFI Settings...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(this,ChangeNetworkParams.class);
                startActivity(intent);
                return true;
            case R.id.item2:
                Toast.makeText(this, "DISCONNECTING FROM AUTO_HOME...", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.item3:
                Toast.makeText(this, "RECONNECTING TO AUTO_HOME...", Toast.LENGTH_SHORT).show();
                return true;
            default:
                return false;
        }
    ...
    class MyTask extends AsyncTask<String, Void, String>
    {
        ...
        {
            //Toast.makeText(getApplicationContext(), "SENT:"+message+" RECEIVED:"+responseStringReceived, Toast.LENGTH_LONG).show();
        }
    }
