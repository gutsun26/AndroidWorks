...
public class SMSReceivedCustomAdapter extends BaseAdapter
{
    private Context mContext;
    SMSReceiverControllerDB controldb;
    SQLiteDatabase db;
    ...
    public SMSReceivedCustomAdapter(Context  context, ArrayList<String> Id, ArrayList<String> theDate, ArrayList<String> theNumber, ArrayList<String> theContent)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        controldb =new SMSReceiverControllerDB(mContext);
