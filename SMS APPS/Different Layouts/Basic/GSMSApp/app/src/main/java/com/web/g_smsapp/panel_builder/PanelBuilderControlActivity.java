...
import com.web.g_smsapp.panel_builder_db.PanelBuilderShowNumbersLocationActivity;
import com.web.g_smsapp.panel_builder_db.PanelBuilderShowReceivedSMSActivity;
...
public class PanelBuilderControlActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener
{
    /******************************MODEL****************************************/
    /*SMS SENDING RELATED*/
    ...
    private static final String TABLE_DEST="PANEL_BUILDER_DEST_NUMBERS";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_panel_builder_control);
        ...
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM PANEL_BUILDER_DEST_NUMBERS",null);
    ...
    public void onItemSelected (AdapterView<?> parent, View view, int position, long id)
    {
        choice = String.valueOf(destNumber.getSelectedItem());
        {
            if (choice.equalsIgnoreCase("-----------------")) {
                ...
                if (!flag) {
                    PanelBuilderControllerDB customerControllerDB = new PanelBuilderControllerDB(this);
    ...
    public void insertData()
    {
        ...
        {
            sqLiteDatabase.execSQL("INSERT INTO PANEL_BUILDER_DEST_NUMBERS(NUMBER, LOCATION) VALUES('" + getReceivingNumber + "','" + getClientString + "')" );
    ...
    public void changeElevatorCompanyNumbers()
    {
        ...
        Intent intent = new Intent(this, PanelBuilderChangeNumbersActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.panel_builder_menu, menu);
        return true;
    }
    ...
    {
        Intent intent=new Intent(this, PanelBuilderShowNumbersLocationActivity.class);
        startActivity(intent);
    }//end of showData()
    ...
    public void showSMS()
    {
        Intent intent=new Intent(this, PanelBuilderShowReceivedSMSActivity.class);
        startActivity(intent);
    }//end of showSMS()

    public void showMeaning()
    {
        Intent intent=new Intent(this, PanelBuilderInformationActivity.class);
        startActivity(intent);
    }//end of showMeaning()

    public void deleteRecords()
    {
        Intent intent = new Intent(this, PanelBuilderRecordsDeleteActivity.class);
        startActivity(intent);
    ...
    BroadcastReceiver smsReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (intentExtras != null)
            {
                ...
                PanelBuilderControlActivity.this.getReceivedSMS(theString);
            }
        }//end of onReceiver()
        ...
        try
        {
            if(!THENUMBER.isEmpty())
            {
                for(int i=0; i<THENUMBER.size(); i++)
                {
                    ...
                    {
                        theSqLiteDatabase.execSQL("INSERT INTO G_PANEL_BUILDER_SMS(DATE, NUMBER, CONTENT) VALUES('"+date+"','"+cellNumber+"','"+extractedMessage+"')");
                ...
                for(int i=0; i<THENUMBER.size(); i++)
                {
                    if(THENUMBER.get(i).equalsIgnoreCase(cellNumber))
                    {
                        ...
                        Intent intent = new Intent(this, PanelBuilderInformationImmediateActivity.class);
                        intent.putExtras(choiceConfig);
                        startActivity(intent);
                    }//end of if{}
                }//end of for()
