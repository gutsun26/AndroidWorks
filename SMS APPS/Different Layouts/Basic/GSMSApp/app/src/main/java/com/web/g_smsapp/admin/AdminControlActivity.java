...
public class AdminControlActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener
{
    /******************************MODEL****************************************/
    /*SMS SENDING RELATED*/
    ...
    BroadcastReceiver smsReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (intentExtras != null)
            {
                ...
                AdminControlActivity.this.getReceivedSMS(theString);
            }
        }//end of onReceiver()
    ...
    public void getReceivedSMS(final String smsMessage)
    {
        ...
        sqLiteDatabase= AdminSMSReceiverControllerDB.getReadableDatabase();
        ...
        try
        {
            if(!THENUMBER.isEmpty())
            {
                for(int i=0; i<THENUMBER.size(); i++)
                {
                    ...
                    {
                        theSqLiteDatabase.execSQL("INSERT INTO G_SMS(DATE, ADDRESS, CONTENT) VALUES('"+date+"','"+cellNumber+"','"+extractedMessage+"')");
                ...
                for(int i=0; i<THENUMBER.size(); i++)
                {
                    if(THENUMBER.get(i).equalsIgnoreCase(cellNumber))
                    {
                        ...
                        Intent intent = new Intent(this, AdminInformationImmediateActivity.class);
                        intent.putExtras(choiceConfig);
                        startActivity(intent);
                    }//end of if{}
                }//end of for()
    ...
    {
        Intent intent = new Intent(this, AdminRecordsDeleteActivity.class);
        startActivity(intent);
