...
public class PanelBuilderCustomAdapter extends BaseAdapter
{
    ...
    public PanelBuilderCustomAdapter(Context  context, ArrayList<String> Id, ArrayList<String> NUMBER, ArrayList<String> LOCATION)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        panelBuilderControllerDB =new PanelBuilderControllerDB(mContext);
