...
public class DeleteSiteActivityFrag1 extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        alertDialogBuilder.setPositiveButton("YES",new DialogInterface.OnClickListener()
        {
            ...
            {
                adminControllerDB = new AdminControllerDB(getApplicationContext());
                sqLiteDatabase = adminControllerDB.getReadableDatabase();
                sqLiteDatabase.execSQL("DELETE FROM ADMIN_CLIENT_DATA WHERE ADMIN_CLIENT_NAME='"+theKey+"'");
                System.exit(0);
            }
        });
