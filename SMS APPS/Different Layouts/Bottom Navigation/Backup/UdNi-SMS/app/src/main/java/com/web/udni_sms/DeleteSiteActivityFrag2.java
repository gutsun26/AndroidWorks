...
public class DeleteSiteActivityFrag2 extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        alertDialogBuilder.setPositiveButton("YES",new DialogInterface.OnClickListener()
        {
            ...
            {
                builderControllerDB = new BuilderControllerDB(getApplicationContext());
                sqLiteDatabase = builderControllerDB.getReadableDatabase();
                sqLiteDatabase.execSQL("DELETE FROM BUILDER_CLIENT_DATA WHERE BUILDER_CLIENT_NAME='"+theKey+"'");
                System.exit(0);
            }
        });
