...
import com.web.udni_sms.AddSiteActivity3;
import com.web.udni_sms.DeleteSiteActivity3;
...
import com.web.udni_sms.customer_db.CustomerCustomAdapter;

import java.util.ArrayList;

public class SitesFragment3 extends Fragment
{
    ...
    {
        root = inflater.inflate(R.layout.fragment_sites3, container, false);
        ...
        customerControllerDB = new CustomerControllerDB(getContext());
    ...
    */
    public void addAndDisplayNewSite()
    {
        ...
        alertDialog.show();*/
        Intent intent = new Intent(getContext(), AddSiteActivity3.class);
    ...
    public void deleteSite()
    {
        ...
        dialog.show();*/
        Intent intent = new Intent(getContext(), DeleteSiteActivity3.class);
        startActivity(intent);
    }//end of deleteSite()

    public void confirmAndDelete(final String clientChosen)
    {
        sqLiteDatabase.execSQL("DELETE FROM CUSTOMER_CLIENT_DATA WHERE CUSTOMER_CLIENT_NAME='"+clientChosen+"'");
    ...
    public void displayData()
    {
        try
        {
            ...
            if(rowCount!=0)
            {
                ...
                CustomerCustomAdapter ca = new CustomerCustomAdapter(getContext(),Id, NAME);
                lv.setAdapter(ca);
            }
            else
            {
