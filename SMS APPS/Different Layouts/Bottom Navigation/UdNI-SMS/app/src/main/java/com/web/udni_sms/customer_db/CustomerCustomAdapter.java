...
import com.web.udni_sms.DeleteSiteActivityFrag3;
import com.web.udni_sms.EditSiteInformationActivity3;
import com.web.udni_sms.R;
import com.web.udni_sms.SendSMSActivity3;
...
public class CustomerCustomAdapter extends BaseAdapter
{
    ...
    CustomerControllerDB controldb,customerControllerDB;
    SQLiteDatabase db, sqLiteDatabase;
    private ArrayList<String> Id = new ArrayList<String>();
    private ArrayList<String> CUSTOMER_CLIENT_NAME = new ArrayList<String>();
    ...
    String theCount;
    String theID="ID";
    public CustomerCustomAdapter(Context  context, ArrayList<String> Id, ArrayList<String> NAME)
    {
        this.mContext = context;
        this.Id = Id;
        this.CUSTOMER_CLIENT_NAME=NAME;
        //this.ADMIN_CLIENT_NUMBER=NUMBER;
        //this.ADMIN_CLIENT_ADDRESS=ADDRESS;
    }
    @Override
    public int getCount() {
        return Id.size();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        controldb =new CustomerControllerDB(mContext);
        LayoutInflater layoutInflater;
        if (convertView == null)
        {
            layoutInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.adapter_layout, null);
            holder = new CustomerCustomAdapter.viewHolder();
            ...
            holder.img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(mContext, SendSMSActivity3.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            holder.name.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    Bundle countBundle = new Bundle();
                    countBundle.putString(theID,nameOfTheSite);
                    Intent intent = new Intent(mContext, DeleteSiteActivityFrag3.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtras(countBundle);
                    mContext.startActivity(intent);
                    return true;
                }
            ...
            holder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Bundle countBundle = new Bundle();
                    countBundle.putString(theID,nameOfTheSite);
                    Intent intent = new Intent(mContext, EditSiteInformationActivity3.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtras(countBundle);
                    mContext.startActivity(intent);
                }
            });
        ...
        holder.name.setText(CUSTOMER_CLIENT_NAME.get(position));
