...
public class BuilderSMSReceivedCustomAdapter extends BaseAdapter
{
    ...
    public BuilderSMSReceivedCustomAdapter(Context  context, ArrayList<String> Id, ArrayList<String> theNumber, ArrayList<String> theContent)
    {
    ...
    {
        final BuilderSMSReceivedCustomAdapter.viewHolder holder;
        ...
        if (convertView == null)
        {
            ...
            holder = new BuilderSMSReceivedCustomAdapter.viewHolder();
        ...
        {
            holder = (BuilderSMSReceivedCustomAdapter.viewHolder) convertView.getTag();
        }
