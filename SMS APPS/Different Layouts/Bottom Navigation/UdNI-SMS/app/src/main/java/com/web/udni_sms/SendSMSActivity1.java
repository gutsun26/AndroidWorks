...
public class SendSMSActivity1 extends AppCompatActivity //implements AdapterView.OnItemSelectedListener //ExpandableListActivity //FragmentActivity
{
    /******************************MODEL****************************************/
    /*SMS SENDING RELATED*/
    /*
    ...
    String  stringCMD9      = "#09%00000CDE";//MAIN CARD OUTPUT
    String  stringCMD10     = "#10%00000CDE";//CBC INPUTS
    ...
    */
    /*THE ACTUAL COMMANDS*/
    /*Below commands were before 12-July-2020*/
    ...
    BroadcastReceiver smsReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (intentExtras != null)
            {
                ...
                {
                    SendSMSActivity1.this.getReceivedSMS(theString);
                }
            }
        }//end of onReceiver()
