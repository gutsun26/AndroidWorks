...
import com.web.g_smsapp.admin_db.AdminCustomAdapter;
...
public class CustomerCustomAdapter extends BaseAdapter
{
    ...
    public CustomerCustomAdapter(Context  context, ArrayList<String> Id, ArrayList<String> NUMBER, ArrayList<String> LOCATION)
    {
